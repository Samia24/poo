...
import { AvisoError, OpcaoInvalidaError } from './excecoes';
...
class AppBanco {
    ...
    constructor() {
        ...
        let conta1: Conta = new Conta('1', 0, new Cliente(1, 'samia'));
        let conta2: Conta = new Conta('2', 40, new Cliente(2, 'maria'));
